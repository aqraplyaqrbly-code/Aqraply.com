...
export const OLD_CATEGORY_MAPPING: Record<string, { mainCategory: string; subcategory?: string }> = {
  ...
  "خضار و فاكهة": { mainCategory: "supermarket_food", subcategory: "vegetables_fruits" },
  ...
  "مستحضرات التجميل ": { mainCategory: "fashion_beauty", subcategory: "cosmetics" },
  "مستحضرات التجميل": { mainCategory: "fashion_beauty", subcategory: "cosmetics" },
  "عطور": { mainCategory: "fashion_beauty", subcategory: "perfumes" },
  "ملابس": { mainCategory: "fashion_beauty", subcategory: "clothing" },
  "ملابس نسائية": { mainCategory: "fashion_beauty", subcategory: "clothing" },
  "أحذية وشنط": { mainCategory: "fashion_beauty", subcategory: "shoes_bags" },
  "أحذية نسائية": { mainCategory: "fashion_beauty", subcategory: "shoes_bags" },
  "إلكترونيات": { mainCategory: "electronics_devices", subcategory: "electronics" },
  "إكسسوارات موبايل": { mainCategory: "electronics_devices", subcategory: "electronics" },
  ...
  "طقم سرير": { mainCategory: "home_furniture", subcategory: "furnishings" },
  "طقم سرير ": { mainCategory: "home_furniture", subcategory: "furnishings" },
  "مكتبات": { mainCategory: "home_furniture", subcategory: "libraries" },
  "ألعاب أطفال": { mainCategory: "home_furniture", subcategory: "toys" },
  "ألعاب رياضية": { mainCategory: "health_sports", subcategory: "sports" },
  ...
  "ساندوتشات": { mainCategory: "restaurants_cafes", subcategory: "restaurants" },
  "مشاوي": { mainCategory: "restaurants_cafes", subcategory: "restaurants" },
  "كنتاكي": { mainCategory: "restaurants_cafes", subcategory: "restaurants" },
  // Clothing items
  "قميص": { mainCategory: "fashion_beauty", subcategory: "clothing" },
  "تيشرت": { mainCategory: "fashion_beauty", subcategory: "clothing" },
  "شوز": { mainCategory: "fashion_beauty", subcategory: "shoes_bags" },
  "طقم البحر ": { mainCategory: "fashion_beauty", subcategory: "clothing" },
};
