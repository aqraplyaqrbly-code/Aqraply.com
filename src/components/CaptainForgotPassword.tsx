...
export default function CaptainForgotPassword() {
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-green-100">
            <div className="text-center">
              ...
              <button
                onClick={() => navigate(`/captain/verify-otp?identifier=${identifier}&type=${identifierType}`)}
                className="w-full py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white font-bold rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2"
              >
