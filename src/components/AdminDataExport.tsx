...
export default function AdminDataExport() {
  ...
  // Queries
  const usersData = useQuery(api.adminExport.exportUsers, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const storesData = useQuery(api.adminExport.exportStores, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const productsData = useQuery(api.adminExport.exportProducts, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const ordersData = useQuery(api.adminExport.exportOrders, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const captainsData = useQuery(api.adminExport.exportCaptains, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const reviewsData = useQuery(api.adminExport.exportReviews, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const walletsData = useQuery(api.adminExport.exportWallets, isAuthenticated && sessionToken ? { sessionToken } : "skip");
  const allData = useQuery(api.adminExport.exportAllData, isAuthenticated && sessionToken ? { sessionToken } : "skip");
